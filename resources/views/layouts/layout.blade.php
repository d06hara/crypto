    ...
    <header class="l-header js-float-menu">
      ...
      <nav class="c-nav js-toggle-sp-menu-target">
        ...
        <ul class="c-nav-menu">
          ...
          <li class="c-nav-menu__item"><a class="c-nav-menu__link" href="{{ url("/mypage") }}">Mypage</a></li>
          <li class="c-nav-menu__item">
    ...
    <div id="app" class="l-main js-float-menu-target">
      ...
      <div class="c-flash" id="c-flash">
        <div class="c-flash__text">
          <p class="c-flash__text--success">{{ session('flash_message') }}</p>
        </div>
      </div>
      @endif
      ...
      <div class="c-flash" id="c-flash">
        <div class="c-flash__text">
          <p class="c-flash__text--error">{{ session('flash_error') }}</p>
        </div>
      </div>
      @endif
      ...
      <div class="c-flash ">
        <div class="c-flash__text">
          <p class="c-flash__text--status">{{ session('status') }}</p>
        </div>
      </div>
      @endif
      {{-- content --}}

    ...
    <main>
      ...
      <div class="p-passremind__container">
        <div id="login" class="p-passremind">
          ...
          <h2 class="p-passremind__title"><span class="p-passremind__title-accent"></span>パスワード変更</h2>
          ...
          <form action="#" method="POST" class="p-passremind__form">
            ...
            <fieldset class="p-passremind__form-fieldset">
              ...
              <p><label for="email">emain</label></p>
              <p><input type="email" placeholder="email"></<input>
              </p>

              <p><label for="password">パスワード</label></p>
              <p><input type="password" placeholder="パスワード"></<input>
              </p>

              <p><label for="password">パスワード（再入力）</label></p>
              <p><input type="password" placeholder="パスワード（再入力）"></<input>
              </p>

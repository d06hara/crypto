...
<body>
  ...
  <div class="l-main">
    <main>
      <p class="l-main__title">パスワード変更</p>
      <div class="p-mypage">
        ...
        <div class="p-mypage__left">
          ...
          <form action="#" method="POST" class="p-passremind__form">
            ...
            <fieldset class="p-passremind__form-fieldset">
              ...
              <p><input type="password" placeholder="古いパスワード"></<input>
              </p>

              <p><label for="password">新しいパスワード</label></p>
              <p><input type="password" placeholder="新しいパスワード"></<input>
              </p>

              <p><label for="password">新しいパスワード（再入力）</label></p>
              <p><input type="password" placeholder="新しいパスワード（再入力）"></<input>
              </p>

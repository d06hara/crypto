    ...
    <div class="card-body">
      <div class="media">
        ...
        <div class="media-body">
          ...
          <h5 class="d-inline mr-3"><strong>{{ $index->name }}</strong></h5>
          {{-- <h6 class="d-inline text-secondary">{{ date('Y/m/d', strtotime($index->status->created_at)) }}</h6> --}}
          <p class="mt-3 mb-0">{{ $index->description }}</p>
        </div>
      </div>
    </div>
